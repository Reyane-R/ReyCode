defmodule ReyCode.Diagnostics do
  ...
  defp limits(%RuntimeConfig{} = config) do
    %{
      ...
      debugger_configured: config.tools.debugger.command != [],
      debugger_timeout_ms: config.tools.debugger.timeout_ms,
      debugger_max_output_bytes: config.tools.debugger.max_output_bytes,
      evaluation_timeout_ms: config.tools.evaluation.timeout_ms,
      evaluation_max_code_bytes: config.tools.evaluation.max_code_bytes,
      evaluation_max_output_bytes: config.tools.evaluation.max_output_bytes,
      evaluation_max_kernels: config.tools.evaluation.max_kernels,
      web_search_configured: config.tools.research.search_endpoint != nil,
