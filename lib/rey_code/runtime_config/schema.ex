defmodule ReyCode.RuntimeConfig.Schema do
  ...
  defp settings do
    [
      ...
      {:steering_max_pending, fn -> 8 end, {:integer, 1}},
      {:steering_max_bytes, fn -> 16_384 end, {:integer, 1}},
      ...
      {:tool_edit_max_patches, fn -> 64 end, {:integer, 1}},
      ...
      {:tool_lsp_command, fn -> [] end, {:list_of, :binary}},
      {:tool_lsp_timeout_ms, fn -> 5_000 end, {:integer, 1}},
      {:tool_lsp_max_output_bytes, fn -> 1_000_000 end, {:integer, 1}},
      {:tool_lsp_max_file_bytes, fn -> 2_000_000 end, {:integer, 1}},
      {:tool_lsp_max_edits, fn -> 256 end, {:integer, 1}},
      {:tool_lsp_env_allowlist, fn -> [] end, {:list_of, :binary}},
      {:tool_lsp_cpu_seconds, fn -> 30 end, {:integer, 1}},
      {:tool_lsp_open_files, fn -> 1_024 end, {:integer, 1}},
      {:tool_process_max_processes, fn -> 8 end, {:integer, 1}},
      {:tool_process_max_output_bytes, fn -> 1_000_000 end, {:integer, 1}},
      {:tool_process_stop_timeout_ms, fn -> 2_000 end, {:integer, 1}},
      {:tool_process_env_allowlist, fn -> [] end, {:list_of, :binary}},
      {:tool_process_cpu_seconds, fn -> 900 end, {:integer, 1}},
      {:tool_process_open_files, fn -> 1_024 end, {:integer, 1}},
      {:tool_debugger_command, fn -> [] end, {:list_of, :binary}},
      {:tool_debugger_timeout_ms, fn -> 10_000 end, {:integer, 1}},
      {:tool_debugger_max_output_bytes, fn -> 1_000_000 end, {:integer, 1}},
      {:tool_debugger_env_allowlist, fn -> [] end, {:list_of, :binary}},
      {:tool_debugger_cpu_seconds, fn -> 120 end, {:integer, 1}},
      {:tool_debugger_open_files, fn -> 1_024 end, {:integer, 1}},
      {:tool_evaluation_python_command, fn -> ["python3"] end, {:list_of, :binary}},
      {:tool_evaluation_javascript_command, fn -> ["node"] end, {:list_of, :binary}},
      {:tool_evaluation_timeout_ms, fn -> 10_000 end, {:integer, 1}},
      {:tool_evaluation_max_code_bytes, fn -> 128_000 end, {:integer, 1}},
      {:tool_evaluation_max_output_bytes, fn -> 1_000_000 end, {:integer, 1}},
      {:tool_evaluation_max_kernels, fn -> 8 end, {:integer, 1}},
      {:tool_evaluation_env_allowlist, fn -> [] end, {:list_of, :binary}},
      {:tool_evaluation_cpu_seconds, fn -> 120 end, {:integer, 1}},
      {:tool_evaluation_open_files, fn -> 1_024 end, {:integer, 1}},
      {:web_search_endpoint, fn -> nil end, :optional_string},
      {:web_search_key_env, fn -> nil end, :optional_string},
      {:web_search_timeout_ms, fn -> 10_000 end, {:integer, 1}},
      {:web_search_max_results, fn -> 10 end, {:integer, 1}},
      {:web_search_max_bytes, fn -> 1_000_000 end, {:integer, 1}},
      {:document_read_timeout_ms, fn -> 15_000 end, {:integer, 1}},
